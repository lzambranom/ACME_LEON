...
@ 02,10 TO 080,380
@ 10,018 Say " Este programa procesara la Tabla de Clientes/Proveedores,"
...
Static Function ActCV0
	...
	Local cQry:=""
	local nX  := 0 //define enero-2022 M&H
	local ny  := 0 //define enero-2022 M&H
...
Local i := 0
Local j:= 0
Local ni  := 0 //define enero-2022 M&H
dbSelectArea("SX1")
dbSetOrder(1)
aRegs:={}
